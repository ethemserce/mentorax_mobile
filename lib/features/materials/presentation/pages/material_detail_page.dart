    ...
    child: Row(
      children: [
        Container(
          ...
          child: Icon(
            material.hasActivePlan ? Icons.check_circle_outline : Icons.schedule,
            color: material.hasActivePlan ? AppColors.success : AppColors.warning,
          ),
        ),
        const SizedBox(width: AppSpacing.md),
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                material.hasActivePlan ? 'Active plan available' : 'No active plan',
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
                  color: AppColors.textPrimary,
                ),
              ...
              Text(
                material.hasActivePlan
                    ? (material.activePlanTitle ?? 'This material already has an active plan.')
...
OutlinedButton.icon(
  ...
  label: const Text('View Plans'),
          ...
          const SizedBox(height: AppSpacing.xl),
AppPrimaryButton(
  text: material.hasActivePlan ? 'Plan Already Exists' : 'Create Study Plan',
      ...
      : () async {
          ...
          if (created == true) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Plan created for this material')),
            );
          }
        },
),
